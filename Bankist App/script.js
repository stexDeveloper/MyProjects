...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-02-05T10:17:24.185Z',
    '2024-03-02T14:11:59.604Z',
    '2024-03-03T17:01:17.194Z',
    '2024-03-05T23:36:17.929Z',
...
const addDate = acc => acc.movementsDates.push(new Date().toISOString());
...
const startLogoutTimer = function () {
  ...
  const tick = function () {
    ...
    //When timer hits 0s, stop timer and log user out
    if (time < 0) {
      clearInterval(timer);
...
btnLoan.addEventListener('click', function (e) {
  ...
  if (amount > 0 && currentAccount.movements.some(mov => mov > amount * 0.1)) {
    setTimeout(
      function (currentAccount, amount) {
        // // Add movement
        currentAccount.movements.push(amount);
        //Add date
        addDate(currentAccount);
